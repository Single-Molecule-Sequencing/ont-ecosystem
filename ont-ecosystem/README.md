...
- 🔬 **Experiment Discovery**: Automatically find and catalog ONT sequencing runs
- 📊 **Provenance Tracking**: Event-sourced history of all analyses with full reproducibility
- 🖥️ **HPC Integration**: Native SLURM/PBS support with GPU-aware job generation
- 🌐 **Public Data Access**: Curated catalog of 30+ ONT Open Data datasets
- 📈 **Web Dashboard**: Browser-based visualization and management
- 🔄 **Pattern B Orchestration**: Centralized analysis workflow management
...
```
~/.ont-registry/
├── experiments.yaml     # Main registry (git-tracked)
└── .git/                # Version history

~/.ont-references/
└── references.yaml      # Reference genome registry
```
